...
* `notebooks/eda.ipynb` → `notebooks/`
* `src/bootcamp_data/io.py` → `src/bootcamp_data/`
* `data/processed/orders.parquet` → `data/processed/`
* `scripts/run_day1_load.py` → `scripts/`
...
* only re-download when you *choose* (TTL or manual delete)
