...
::: {.muted}
Build: `notebooks/eda.ipynb` + exported figures + bootstrap result
:::
...
* `notebooks/eda.ipynb` reading only from `data/processed/analytics_table.parquet`
* 3–6 answered questions with:

  * a summary table
  * a chart
  * bullet interpretations + caveats
* **3+ exported figures** in `reports/figures/`
* 1 bootstrap CI result (in notebook)
...
::: {.muted}
Notebooks should read processed outputs, not raw.
:::

---

## Task 1 — Create the EDA notebook skeleton (10 minutes)

Create `notebooks/eda.ipynb` with sections:
...
**Checkpoint:** notebook runs top-to-bottom without errors (even if empty results).

---

## Solution — starter imports (paste into first cell)
...
## Task 2 — Load + audit (15 minutes)

In your notebook:

* load `analytics_table.parquet`
* print:
...
**Checkpoint:** you can write 2 bullets describing the dataset quality.

---

## Solution — load + audit (example)
...
## Task 3 — Define your EDA questions (10 minutes)

Write **3–6 questions** at the top of the notebook.

Rule: each question must map to:

* a table
* a chart
* 2–4 bullets

**Checkpoint:** questions are written as measurable sentences.

---

## Solution — question list template
...
## Task 4 — Question 1: Revenue by country (20 minutes)

Build:

* table: `n`, `revenue`, `aov`
* chart: sorted bar
* bullets: 2–4 interpretations + 1 caveat

Export chart to `reports/figures/revenue_by_country.png`.

**Checkpoint:** PNG exists and opens.

---

## Solution — revenue by country (example) {.smaller}
...
## Task 5 — Question 2: Revenue trend (monthly) (20 minutes)

Build:

* table: `month`, `n`, `revenue`
* chart: line
* bullets: 2–4 interpretations + 1 caveat

Export to `reports/figures/revenue_trend_monthly.png`.

**Checkpoint:** x-axis is in time order.

---

## Solution — trend chart (example)
...
## Task 6 — Question 3: Amount distribution (winsorized) (15 minutes)

Build:

* chart: histogram of `amount_winsor`
* bullet: what “typical” looks like + mention skew/outliers

Export to `reports/figures/amount_hist_winsor.png`.

**Checkpoint:** histogram renders and exports.

---

## Solution — histogram (example)
...
## Task 7 — Bootstrap comparison (25 minutes)

Choose a comparison:

* mean amount between 2 groups, OR
* refund rate between 2 groups (0/1 mean)
...
**Checkpoint:** your notebook prints a CI and you interpret it in 2 bullets.

---

## Solution — bootstrap diff means (copy into notebook) {.smaller}
...
* `"w2d4: eda notebook + exported figures + bootstrap"`

**Checkpoint:** you can see your commit on GitHub.
...
```bash
git add -A
git commit -m "w2d4: eda notebook + exported figures + bootstrap"
git push
```

---

## Debug playbook (Day 4 edition)

If your EDA looks wrong:

1. Confirm you loaded from `data/processed/` (not raw) 
2. Print dtypes (IDs as strings, datetimes parsed)
3. Check missingness for key columns (country/status/amount)
4. For trends: confirm month sorting
5. For exports: install kaleido and re-run export cell
...
* Add a facet chart (e.g., histogram by country)
* Create a small “data dictionary” cell listing key columns + meaning
* Add one more comparison question with a second bootstrap CI
...
**What is one conclusion you can make from your charts, and what is one caveat?** 

---

## What to do after class (Day 4 assignment)

**Due:** before Day 5 starts

1. Finish `notebooks/eda.ipynb` with **3–6 questions**
2. Export **at least 3 figures** to `reports/figures/`
3. Include **one bootstrap CI** comparison
4. Push to GitHub

**Deliverable:** GitHub repo link + screenshot of `reports/figures/` folder showing your exported images.

::: callout-tip
Tomorrow you’ll write the final summary + package the project like a real handoff.
:::
